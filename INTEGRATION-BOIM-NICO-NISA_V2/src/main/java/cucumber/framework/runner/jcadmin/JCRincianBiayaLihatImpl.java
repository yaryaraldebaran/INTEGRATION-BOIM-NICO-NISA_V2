...
public class JCRincianBiayaLihatImpl {
	private static WebDriver driver;
	private static ExtentTest extentTest;
	private JCAdminRincianBiayaPage JCAdminRB; 
	String strDelay = Constants.GLOB_PARAM_DELAY;
	
	public JCRincianBiayaLihatImpl() {
	...
	public void ri003p_admin_melihat_rincian_biaya_berdasarkan_harga_normal() {
		...
		extentTest.log(LogStatus.PASS, "Admin melihat rincian biaya berdasarkan harga normal");
	}
	...
	public void ri004p_admin_melihat_rincian_biaya_berdasarkan_diskon() {
	    ...
	    assertTrue(comDis);
	    extentTest.log(LogStatus.PASS, "Admin memlihat rincian biaya berdasarkan diskon");
	}
	...
	public void ri005p_admin_memilih_opsi_harga_hasil_diskon() {
	    ...
	    Utils.delay(5, strDelay);
	    extentTest.log(LogStatus.PASS, "Admin memilih opsi harga hasil diskon");
	}
	...
	public void ri005p_admin_melihat_rincian_biaya_berdasarkan_harga_hasil_diskon() {
		...
		extentTest.log(LogStatus.PASS, "Admin melihat rincian biaya berdasarkan harga hasil diskon");
	}
