...
public class JCRincianBiayaEditImpl {
	...
	@When("^RI010P Admin melakukan edit nama program positive dengan (.*)$")
	public void admin_mengedit_nama_program_dengan_nama_program(String namaProgramBaru) {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin melakukan edit nama program dengan "+namaProgramBaru);
	}
	...
	@Then("^RI010P Admin melakukan edit nama program THEN (.*)$")
	public void admin_mengedit_nama_program(String namaProgramBaru) {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin telah melakukan edit nama program");
	}
	//INI AKHIR EDIT NAMA PROGRAM
	
	//INI AWAL EDIT HARGA NORMAL
	@When("^RI011P Admin melakukan edit harga awal positive dengan (.*)$")
	...
	@Then("^RI011P Admin melakukan edit harga awal THEN (.*)$")
	public void admin_mengedit_harga_awal(String hargaBaru) {
		JCAdminRB.goToHome();
		JCAdminRB.goToRincianBiaya();
		assertTrue(JCAdminRB.compEditHarga(hargaBaru));
	    System.out.println("admin melakukan edit harga awal");
	    extentTest.log(LogStatus.PASS, "Admin telah melakukan edit harga awal");
	}
	//INI AKHIR EDIT HARGA NORMAL
	
	//INI AWAL EDIT DISKON 
	
	@When("^RI012P Admin melakukan edit diskon positive dengan (.*)$")
	public void admin_mengedit_diskon_dengan_diskon(String diskonBaru) {
		JCAdminRB.editDiskon(diskonBaru);
		extentTest.log(LogStatus.PASS, "Admin telah melakukan edit diskon menjadi "+diskonBaru);
	}
	...
	@Then("^RI012P Admin melakukan edit diskon THEN (.*)$")
	public void admin_mengedit_diskon(String diskonBaru) {
		...
		extentTest.log(LogStatus.PASS, "Admin telah melakukan edit diskon");
	}
	...
	@When("^RI013P Admin melakukan edit keunggulan1 positive dengan (.*)$")
	public void admin_mengedit_keunggulan1_dengan_keunggulan1(String keunggulan1) {
	    
	    JCAdminRB.editKeunggulan1(keunggulan1);
	    extentTest.log(LogStatus.PASS, "Admin melakukan edit keunggulan 1 menjadi "+keunggulan1);
	}
	...
	@Then("^RI013P Admin melakukan edit keunggulan1 THEN (.*)$")
	public void admin_mengedit_keunggulan1(String keunggulan1Baru) {
		...
		extentTest.log(LogStatus.PASS, "Admin telah melakukan edit keunggulan 1");
	}
	//INI AKHIR EDIT KEUNGGULAN 1
	
	
	//INI AWAL EDIT KEUNGGULAN 2
	@When("^RI013P Admin melakukan edit keunggulan2 positive dengan (.*)$")
	public void admin_mengedit_keunggulan2_dengan_keunggulan2(String keunggulan2) {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin melakukan edit keunggulan 2 menjadi "+keunggulan2);
	}
	...
	@Then("^RI013P Admin melakukan edit keunggulan4 THEN (.*)$")
	public void admin_mengedit_keunggulan4(String keunggulan4Baru) {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin telah melakukan edit keunggulan 4");
	}
	//INI AKHIR EDIT KEUNGGULAN 4
	
	//INI AWAL EDIT KEUNGGULAN 5
	@When("^RI013P Admin melakukan edit keunggulan5 positive dengan (.*)$")
	public void admin_mengedit_keunggulan5_dengan_keunggulan5(String keunggulan5) {
		Utils.fullScroll();
		Utils.delay(3, strDelay);
	    JCAdminRB.editKeunggulan5(keunggulan5);
	    extentTest.log(LogStatus.PASS, "Admin melakukan edit keunggulan 5 menjadi "+keunggulan5);
	}
	...
	@Then("^RI013P Admin melakukan edit keunggulan5 THEN (.*)$")
	public void admin_mengedit_keunggulan5(String keunggulan5Baru) {
	    JCAdminRB.goToHome();
	    JCAdminRB.goToRincianBiaya();
	    //INI VALIDATOR EDIT KEUNGGULAN1
	    assertTrue(JCAdminRB.compEditKeunggulan5(keunggulan5Baru));
	    extentTest.log(LogStatus.PASS, "Admin telah melakukan edit keunggulan 5");
	}
