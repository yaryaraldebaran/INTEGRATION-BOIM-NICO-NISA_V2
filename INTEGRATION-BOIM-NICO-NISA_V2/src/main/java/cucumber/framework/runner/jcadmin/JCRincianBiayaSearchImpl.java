...
public class JCRincianBiayaSearchImpl {
	...
	public void admin_login_dan_membuka_cari_halaman_rincian_biaya_untuk_mencari_rb() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin login dan membuka cari halaman rincian biaya untuk mencari rincian biaya");
	}
	...
	public void ri018p_admin_memilih_opsi_nama_program() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin memilih opsi nama program");
	}
	...
	public void ri018p_admin_melihat_hasil_search_cari_nama_program() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin melihat hasil search cari nama program");
	}
	...
	public void ri018p_admin_memilih_opsi_harga_normal() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin memilih opsi harga normal");
	}
	...
	public void ri018p_admin_melihat_hasil_search_cari_harga_normal() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin melihat hasil search cari harga normal");
	}
	...
	public void ri020p_admin_memilih_opsi_diskon() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin memilih opsi diskon");
	}
	...
	public void ri020p_admin_melihat_hasil_search_cari_diskon() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin melihat hasil search diskon");
	}
	...
	public void ri021p_admin_memilih_opsi_harga_diskon() {
	    ...
	    extentTest.log(LogStatus.PASS, "Admin memilih opsi harga diskon");
	}
	...
	public void ri021p_admin_melihat_hasil_search_cari_harga_diskon() {
		...
		extentTest.log(LogStatus.PASS, "Admin melihat hasil search cari harga diskon");
	}
