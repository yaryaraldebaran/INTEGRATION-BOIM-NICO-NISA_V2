...
public class JCAdminBenefitPage extends JCAdminLoginPage 
{
	...
	private WebElement vldTambahBenefit;
	@FindBy (xpath ="//alert[@class='alert alert-success']")
    private WebElement vldEditBenefit;
...
//		this.btnTambahBenefit.click();
		...
		new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(btnTambahBenefit)).click();
	}
...
//		this.submitBenefit.click();
		new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(submitBenefit)).click();
	}
...
//	    this.btnBenefitPertama.click();
	    new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(btnBenefitPertama)).click();
	}
...
//		this.judul1.click();
		new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(judul1)).click();
		Utils.clearField();
		Utils.delay(2, strDelay);
		new WebDriverWait(driver, Duration.ofSeconds(15))
        .until(ExpectedConditions.visibilityOf(judul1)).sendKeys(isJud);;
...
//		this.judul2.click();
		new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(judul2)).click();
		Utils.clearField();
		Utils.delay(2, strDelay);
	...
	public void editJudul3BenefitPertama(String isJud) {
		...
		Utils.scrollFullMouse(150);
//	    this.judul3.click();
	    new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(judul3)).click();
	    Utils.delay(1, strDelay);
		Utils.clearField();
		Utils.delay(2, strDelay);
//		this.judul3.sendKeys(isJud);
		new WebDriverWait(driver, Duration.ofSeconds(15))
        .until(ExpectedConditions.visibilityOf(judul3)).sendKeys(isJud);
        Utils.fullScroll();
		Utils.delay(2, strDelay);
	}
	public void editJudul4BenefitPertama(String isJud) {
	    ...
	    new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(judul4)).click();
//		this.judul4.click();
		Utils.clearField();
		Utils.delay(2, strDelay);
	...
	public void editDeskripsi1BenefitPertama(String isiDesc) {
	    new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(deskripsi1)).click();
//		this.deskripsi1.click();
		Utils.clearField();
		new WebDriverWait(driver, Duration.ofSeconds(15))
        .until(ExpectedConditions.visibilityOf(deskripsi1)).sendKeys(isiDesc);
	}
	public void editDeskripsi2BenefitPertama(String isiDesc) {
        this.deskripsi2.click();
        new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(deskripsi2)).click();
//        Utils.clearField();
        new WebDriverWait(driver, Duration.ofSeconds(15))
        .until(ExpectedConditions.visibilityOf(deskripsi2)).sendKeys(isiDesc);
    }
	public void editDeskripsi3BenefitPertama(String isiDesc) {
	    
	    Utils.delay(3, strDelay);
	    Utils.setengahScroll("800");
//	    this.deskripsi3.click();
	    new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(deskripsi3)).click();
        Utils.clearField();
        new WebDriverWait(driver, Duration.ofSeconds(15))
        .until(ExpectedConditions.visibilityOf(deskripsi3)).sendKeys(isiDesc);;
...
//        this.deskripsi4.click();
        new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(deskripsi4)).click();
        
        Utils.clearField();
        
        new WebDriverWait(driver, Duration.ofSeconds(15))
        .until(ExpectedConditions.visibilityOf(deskripsi4)).sendKeys(isiDesc);;
    }
...
//		this.submitEditBenefit.click();
		new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(submitEditBenefit)).click();
		Utils.delay(3, strDelay);
	}
    ...
    public String getVldAdd() {
        ...
        return new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(vldTambahBenefit)).getText();
    }
    public String getVldEdit() {
        //"Data berhasil di tambah"
        return new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(vldEditBenefit)).getText();
    }
