Feature: Rincian Biaya   
  Scenario Outline: Menambah daftar rincian biaya baru active
    ...
    And <kode test case> Admin menekan tombol simpan tambah rincian biaya baru
    Then <kode test case> Admin menambah rincian biaya biaya baru dengan active valid
